...
**<$LogFile Event>**   
    - File Creation : 파일 생성<br>
    - File Deletion : 파일 삭제<br>
    - Writing Content of Resident File : 파일 데이터 변경(700byte이하 파일)<br>
    - Writing Content of Non-Resident File : 파일 데이터 변경(700byte 이상 파일)<br>
    - Renaming File : 파일 이름 변경<br>
    - Directory Creation : 디렉토리 생성<br>
    - Directory Deletion : 디렉토리 삭제<br>
